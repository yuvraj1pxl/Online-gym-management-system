...
CSRF_TRUSTED_ORIGINS = [
    "https://*.ngrok-free.app",   # if you use ngrok
    
    "https://*.vscode.dev",  # VS Code port forwarding
...
# -- static & media (add near other settings) --
from pathlib import Path
BASE_DIR = Path(__file__).resolve().parent.parent

STATIC_URL = '/static/'
# If you keep app-level static as body/static/body/..., keep this path
STATICFILES_DIRS = [BASE_DIR / 'body' / 'static']
STATIC_ROOT = BASE_DIR / 'staticfiles'

# media (for uploaded profile pics)
MEDIA_URL = '/media/'
